...
public class PayrollRepo extends Repo<Payroll> {
    ...
    public Payroll addPayroll(Payroll payroll) throws SQLException {
        ...
        String newrows = "(company_id, cif, company_name, company_address, city, ccc, employee_id, employee_name, employee_second_name, employee_last_name, nif, naf,job_position, retributive_group, establishment_category, start_date, end_date, datediff, base_salary, complement_1_name,complement_2_name, complement_3_name, complement_1_import, complement_2_import, complement_3_import, complementary_hours_import, " +
