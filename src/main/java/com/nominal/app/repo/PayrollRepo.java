...
public class PayrollRepo extends Repo<Payroll> {
    ...
    String rows = "(company_id, cif, company_name, company_address, city, ccc, employee_id, employee_name, employee_second_name, employee_last_name, nif, naf,job_position," +
        ...
        return super.add(payroll, "payrolls ",rows, payroll.toQueryInfo() );
    }
